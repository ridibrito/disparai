...
export default function EditarAgentePage() {
  ...
  console.log('EditarAgentePage - User:', user, 'Loading:', isLoading);
  ...
  const tabs = [
    ...
    { id: 'review', label: 'Revisão', icon: CheckCircle, description: 'Revisar e salvar alterações' }
  ];
    ...
    const loadAgent = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          response_delay_ms: data.response_delay_ms || 2000,
        ...
        if (data.knowledge_files) {
          setUploadedFiles(data.knowledge_files);
        }
      } catch (error) {
  ...
  console.log('EditarAgentePage - Render state:', { isLoading, user: !!user, loadingAgent, currentTab });
    ...
    return (
      <div className="space-y-6">
        <div className="mb-8 mt-4">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Editar Agente</h1>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">O agente que você está tentando editar não existe.</p>
          <Link href="/configuracoes/agentes">
            <Button>Voltar para Agentes</Button>
          </Link>
        </div>
      </div>
    );
      ...
      <div className="mb-8 mt-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Editar Agente</h1>
              <p className="text-gray-600">Modifique as configurações do agente {agent.name}</p>
            </div>
          </div>
          ...
          >
            ...
            {showTestChat ? 'Fechar Teste' : 'Testar Agente'}
          </Button>
        </div>
      </div>
          ...
          <TabsContent value="review" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Revise todas as configurações antes de salvar as alterações
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
