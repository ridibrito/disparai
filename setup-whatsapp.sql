-- Setup completo para WhatsApp Cloud API + OpenAI
...
-- Políticas para tabelas multi-tenant
...
INSERT INTO public.tenants (id, name, slug, company_name, owner_name, owner_email)
VALUES (
...
-- Inserir conta WhatsApp padrão para testes
INSERT INTO public.wa_accounts (tenant_id, waba_id, phone_number_id, access_token)
VALUES (
  '00000000-0000-0000-0000-000000000001',
  'test_waba_id',
